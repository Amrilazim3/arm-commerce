...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    productReceive: function productReceive(billId) {
      var _this2 = this;
      ...
      this.$swal.fire({
        ...
        if (result.isConfirmed) {
          _this2.$inertia.patch("/user/purchase/to-receive", {
            orderIds: orderIds
          }, {
            preserveScroll: true,
            onSuccess: function onSuccess() {
              ...
              _this2.$swal.fire("Success!", "Thank you for your commitment", "success");
            },
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Head, {
    ...
    /* TEXT */
      ...
      onClick: function onClick($event) {
        return $options.productReceive(list.billId);
      },
    ...
    /* TEXT */
      ...
      /* TEXT */
      ), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", _hoisted_29, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(ship.order.cart.price / ship.order.cart.quantity) + "MYR ", 1
      /* TEXT */
